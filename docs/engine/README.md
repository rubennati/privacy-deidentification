...
| Benchmark / regression | **L10 done** | matching, routing correctness, PII P/R/F1, privacy guard, determinism, validation counts, read-only per-profile comparison, safe OCR confidence/coverage columns | L11 OCR runtime/memory |
